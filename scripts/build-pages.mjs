...
extension. Host access is never granted up front: the extension asks per site, the first time you
annotate there. The full statement is in the <a href="./privacy.html">privacy policy</a>.</p>
<h2>Get it</h2>
<ul>
