...
`doc/` (hand-wrapped prose, plus the read-only design mock) and `docs/` (generated by
`npm run pages` — Prettier and the generator would overwrite each other) out of it.
